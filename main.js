...
Apify.main(async () =>
{
    ...
    const kvStore = await Apify.openKeyValueStore('COVID-19-UK-TEST');
    const dataset = await Apify.openDataset('COVID-19-UK-HISTORY-TEST');
    ...
    const result = await page.evaluate(() =>
    {
        ...
        const data = {
            ...
            wales: getInt(wales),
            'northen ireland': getInt(ireland),
